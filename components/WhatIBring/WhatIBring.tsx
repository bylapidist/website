    ...
    return (
        <Container>
            ...
            >
                ...
                <p>
                    My experience ranges from MVPs to fintech platforms adopted
                    by hundreds of engineers and tens of thousands of users.
                </p>
                <p>
                    I pair tooling with clear governance so UI and API contracts
                    evolve without regressions, and without sacrificing quality
                    as it scales.
                </p>
