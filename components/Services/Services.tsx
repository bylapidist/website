        ...
        <Section id="services" heading="Signature services" className={styles.services}>
            <div className={styles.cards}>
                <Card title="Design System Bootstrap" highlight>
                    <img src="/placeholder.svg" alt="" className={styles.icon} />
                    <p>
                ...
                <Card title="System Audit & Roadmap">
                    ...
                    <p>
                        ...
                        illuminating gaps and mapping a path to scale.
                    </p>
                </Card>
                <Card title="Hands-on Build">
                    ...
                    <p>
                        ...
                        team — patterns and processes that last.
                    </p>
                </Card>
                <Card title="Advisory & Team Uplift">
                    ...
                    <p>
                        ...
                        tailored standards, coaching, and reviews that raise
                        quality.
                    </p>
                </Card>
            </div>
