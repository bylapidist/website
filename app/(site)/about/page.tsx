            ...
            <Section heading="About me" headingLevel={1}>
                <div className={styles.article}>
                    ...
                    <ul>
                        ...
                        <li>
                            Proven track record of saving teams months of rework
                            by aligning design systems and tooling to business
                            goals.
                        </li>
                        <li>
                    ...
                    <p>
                        ...
                        not just my health but my approach to engineering. That
                        experience reshaped my outlook: I no longer see success
                        as speed at all costs, but as sustainable delivery that
                        supports both the people who use software and the teams
                        who build it.
                    </p>
                    <p>
                        Months of rehabilitation taught me pacing, adaptability,
                        and perspective. It reminded me that engineering culture
                        - like health - needs sustainability at its core. I now
                        carry that lesson into every team I work with: design
                        systems, processes, and platforms should protect people,
                        not drain them.
                    </p>
                    <p>
                        I specialise in building design systems and frontend
                        platforms that embed accessibility, governance, and
                        developer velocity from the start. My goal is to serve
                        both users and engineers by creating systems that scale
                        gracefully, reduce hidden risks, and improve day-to-day
                        developer culture.
                    </p>
                    <p>
                        Above all, I build with a human-centred, sustainable
